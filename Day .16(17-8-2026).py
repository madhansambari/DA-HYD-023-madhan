...
Dictionary is Mutable,Indexed through keys,Ordered,Heterogenous,keys must be Unique (int,float values.....)
'''
...
#pritn(details['marks']) #KeyError as marks is not present
details['marks']=[]
print(details)
...
print(details)
details['marks'].extend([15,20,25,30,35,40])
print(details)
...
print(details.keys())
#Accessing 3rd day of practice session
...
#update() ---> updating the dictioary with key-value pairs
...
print(details.get('Branch','ECE')) #it returns None as we dont have Branch as key
print(details.keys())
...
b['saketh']=31
print(b)
c=dict.fromkeys(['CGH123','CGH234'],['code','gnan'])
print(c)
